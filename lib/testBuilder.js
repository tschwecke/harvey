		...
		var testInvoker = function(callback) {
			...
			if(test.skip === true) {
				...
				for(var i=0; i<test.setup.length; i++) {
					...
					var setupInvoker = testStepBuilder.buildTestStep("testSetup", setup, requestTemplates, responseTemplates, testStepInfo.parameters, testVariables, status);
				...
				for(var i=0; i<test.verifications.length; i++) {
					...
					var verificationInvoker = testStepBuilder.buildTestStep("testVerification", verification, requestTemplates, responseTemplates, testStepInfo.parameters, testVariables, status);
				...
				for(var i=0; i<test.teardown.length; i++) {
					...
					var teardownInvoker = testStepBuilder.buildTestStep("testTeardown", teardown, requestTemplates, responseTemplates, testStepInfo.parameters, testVariables, status);
