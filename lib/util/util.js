...
module.exports = new (function() {
	...
	this.parseValue = function(value, variables) {
		var parsedValue;
		if(_.isArray(value)) {
			parsedValue = [];
			...
			for(var prop in value) {
				if(prop.substr(0,1) === '$') {
					...
					parsedValue = action(value[prop], variables, self.getParseValueFacade(variables));
				}
			}
